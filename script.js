...
window.addEventListener('load', () => {
    ...
    if (container && typeof THREE !== 'undefined') {
        ...
        controls.enableZoom = false; controls.enableRotate = true; controls.autoRotate = true; controls.autoRotateSpeed = 2.0;
        ...
        satelliteGroup.rotation.z = Math.PI / 4; satelliteGroup.rotation.x = Math.PI / 6;
